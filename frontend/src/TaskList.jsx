...
class TaskList extends Component {
    ...
    render() {
        ...
        const taskList = this.props.tasks.map(eachTask => (
              <Task key={eachTask.id} id= {eachTask.id} name={eachTask.task_name} description={eachTask.task_description} status={eachTask.complete_status} createdTime={eachTask.updated_at}/>
        ))
